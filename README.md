...
I contributed to the backend development of an Expense Tracker application by designing and implementing RESTful APIs for managing expenses, including adding, updating, viewing, and deleting records. I handled database design and CRUD operations for users and expense data, and implemented user authentication and authorization to ensure secure access. I also developed core logic for calculating totals, filtering expenses by category and date, and generating summaries. Additionally, I performed input validation, error handling, and tested APIs to ensure smooth integration with the frontend.
